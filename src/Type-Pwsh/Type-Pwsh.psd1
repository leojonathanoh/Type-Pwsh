...
FunctionsToExport = 'explain', 'tellme', 'whatis'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'interactive','english','funny','simplicity','layman','satirical','pwsh','brainy','philosophical','humorous','catty','comical','suspensive','humanly','watery','flowy'
